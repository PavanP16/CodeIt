    ...
    <div className="px-64">
      ...
      <div className="bg-white h-fit">
        <Table isStriped shadow="none">
          <TableHeader>
            <TableColumn className="text-bold text-sm text-gray-700">#Rank</TableColumn>
            <TableColumn className="text-bold text-sm text-gray-700">Username</TableColumn>
            <TableColumn className="text-bold text-sm text-gray-700">
              Questions solved in 30 days
            </TableColumn>
            <TableColumn className="text-bold text-sm text-gray-700">Overall Score</TableColumn>
          </TableHeader>
          <TableBody>
            {data.map((rs, idx) => {
              return (
                <TableRow key={idx} className="py-3">
                  ...
                  <TableCell className="w-72 py-4 font-light">{rs.name}</TableCell>
                  <TableCell className="pl-20">{rs.days}</TableCell>
